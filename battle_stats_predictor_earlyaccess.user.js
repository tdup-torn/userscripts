...
styleToAdd.innerHTML ='.style-bs-api { background: var(--main-bg); text-align: center; left: 0; top: 0; width: 100%; height: 100%; padding-bottom : 5px; padding-top : 5px;}'+
...
function InjectOptionMenu(node) {
    ...
    checkboxLabel.appendChild(document.createTextNode('[Recommended] Use compare mode'));
    compareCheckBoxNode.appendChild(checkboxLabel);

    compareCheckBoxNode.appendChild(checkbox);

    // USE TORN STATS SPIES
    let tornStatsCheckBoxNode = document.createElement("div");
    tornStatsCheckBoxNode.className = "text faction-names style-bs-api";
    tornStatsCheckBoxNode.style.display = (!LOCAL_API_KEY_IS_VALID) ? "block" : "none";
    ...
    tornStatsNode.className = "text faction-names style-bs-api";
    tornStatsNode.style.display = (LOCAL_USE_TORN_STATS_SPIES && !LOCAL_API_KEY_IS_VALID) ? "block" : "none";
    ...
    tornStatsApiKeyDiv.className = "text faction-names style-bs-api";
    ...
    tornStatsImportDiv.className = "text faction-names style-bs-api";
    ...
    apiKeyButton.addEventListener("click", () => {
        if (apiKeyNode.style.display == "block") {
            ...
            apiKeyNode.style.display = "block";
            comparisonBattleStatsNode.style.display = LOCAL_USE_COMPARE_MODE ? "block" : "none";
            tornStatsNode.style.display = LOCAL_USE_COMPARE_MODE ? "block" : "none";
            colorSettingsNode.style.display = LOCAL_USE_COMPARE_MODE ? "block" : "none";
    ...
    node.appendChild(tornStatsCheckBoxNode);
    node.appendChild(tornStatsNode);
